package com.mathroda.common.theme
...
val CustomBrightGreen = Color(0xFF50DE91)
val CustomRed = Color(0xFFE8503A)
val CustomBrightRed = Color(0xFFFE4024)
val TextWhite = Color(0xFFEEEEEE)
val Gold = Color(0xFFE6C149)
val Twitter = Color(0xFF00ACEE)
val SplashBackground = Color(0xff00B4FF)
val BackgroundBlue = Color(0xff005EDA)