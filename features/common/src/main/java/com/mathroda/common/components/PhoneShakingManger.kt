...
internal fun PhoneShakingManger(
    ...
    var acceleration by remember { androidx.compose.runtime.mutableFloatStateOf(0f) }
    var currentAcceleration by remember { androidx.compose.runtime.mutableFloatStateOf(0f) }
